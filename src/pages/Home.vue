        ...
        <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
            ...
            <div class="sm:col-span-3 text-sm">
              Tổng:
              <span :class="sumPctEff===100 ? 'text-teal-600 font-semibold' : 'text-rose-600 font-semibold'">
                {{ sumPctEff.toFixed(1) }}%
              </span>
        ...
        <div class="p-4">
          ...
          <div
            ...
            :class="[
              ...
              kcalNotice.tone==='ok'   ? 'bg-teal-50 border-teal-200 text-teal-700' : ''
            ]"
          >
...
.btn-primary { @apply bg-white text-teal-700 hover:bg-teal-50 active:scale-95; }
...
.row  { @apply rounded-xl bg-gray-50/80 border border-gray-200; }
.cell { @apply p-2; }
.cell.muted  { @apply text-slate-500; }
.cell.strong { @apply font-semibold text-slate-800; }
.table-shell { overflow: visible !important; }
.modern-table { min-width: 0 !important; table-layout: fixed; border-collapse: collapse; border: 1px solid #e2e8f0; width: 100%; }
...
@media (min-width: 641px) {
  ...
  .modern-table td:nth-child(2) { text-align: center; }
  .modern-table td:nth-child(3),
  .modern-table td:nth-child(4),
  .modern-table td:nth-child(5),
  .modern-table td:nth-child(6) { text-align: right; }
}
